...
<head>
  ...
  <title>404 - Page Not Found | WireGuard Admin</title>
...
<body class="gradient-bg min-h-screen flex items-center justify-center p-4">
  <div class="w-full max-w-md text-center">
    <div class="glass-effect rounded-2xl p-8 backdrop-blur-lg">
      ...
      <h2 class="text-xl text-gray-200 mb-4">Page Not Found</h2>
      <p class="text-gray-300 mb-8">The page you are looking for could not be found.</p>
