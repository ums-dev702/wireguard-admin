...
/**
 *  Cortech Systems - Network Management Platform (https://github.com/hotspotbilling/Cortech Systems/)
 *  by https://t.me/ibnux
 **/
...
if($_app_stage!="Live"){
    ...
    fwrite($fh, $input);
    fclose($fh);
    $sql = file_get_contents('Cortech Systems.sql');
    $qr = $dbh->exec($sql);
    if (isset($_POST['radius']) && $_POST['radius'] == 'yes') {
...
<head>
    <title>Cortech Systems Installer</title>
...
<body style='background-color: #FBFBFB;'>
    <div id='main-container'>
        ...
        <div class="span12">
            <h4> Cortech Systems Installer </h4>
            <?php
            if ($cn == '1') {
            ?>
            ...
            ?>
                <p> MySQL Connection was successfull. An error occured while adding data on MySQL. Unsuccessfull
                    Installation. Please refer manual installation in the website github.com/ibnux/Cortech Systems/wiki or Contact Telegram @ibnux  for
    ...
    <div class="footer">Copyright &copy; 2021 Cortech Systems. All Rights Reserved<br /><br /></div>
</body>
